...
@section('pageTitle', 'About John Blackmore - Remote Freelance PHP Developer based in Taunton, UK')
...
@section('content')
    ...
    Hello, I’m John. I am a **freelance PHP developer** and digital marketing specialist with over ten years of commercial experience in everything
    from brochure websites to eCommerce, Software as a Service (SaaS) online applications and small enterprise management systems. **I work remotely** from my studio in Taunton, UK.
    ...
    - An **insurance quote engine** used by a group of companies to quote and provide cover for thousands of tradespeople around the UK, offering a number of insurance products and combining over 30 risk factors to provide a unique quote for every customer.
    ...
    - Consulted on and then implemented **improved developer workflows** for a UK growth-stage company, introductin local development builds, implementing continuous integration pipelines, and designed a **zero-downtime deployment platform** to ship the code to staging and production environments.
    ...
    I am always looking for interesting projects to work on. I have worked with startups, scale-ups, and larger companies for both hands-on development and consulting roles. Here are some of the types of projects that I have particularly good knowledge of:
    ...
    - **Improved Developer Workflows**: You might already have a team in place, but you want to get a better handle on local development and deploying your code? I have built a number of development and deployment processes that allow you to reliably and confidently ship code without having to work late nights and weekends. I have worked in teams where we were able to ship to production with zero-downtime, enabling us to ship upwards of 30 code changes a day during working hours.
    ...
    I am current available to hire for one-off projects and on-going contract work (1-5 days a week). I am a **remote worker based in Taunton**, Somerset working from my studio, although I am also able to attend on-site meetings as required (expenses paid). I would be more than happy to discuss any requirements you might have, so please give me a call or send an email to see what I can do for you.
